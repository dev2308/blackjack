package main.genericstuff;// A Java program for a Server
...
public abstract class GenericServer
{
	...
	protected ClientProxy addClient(Socket clientSocket) throws IOException {
	...
	protected class ClientProxy extends Thread {
		...
		public void sendMessageToClient(Command command, String message) throws IOException {
